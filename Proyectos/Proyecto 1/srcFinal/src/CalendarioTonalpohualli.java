...
/**
 * Representación del calendario Tonalpohualli, es decir, convierte fechas del
 * calendario Gregoriano a fechas del Calendario Tonalpohualli.
 *
...
public class CalendarioTonalpohualli {
    ...
    /**
     * Nombres de los 4 signos del calendario en Nahuatl.
     */
    ...
    public String getAnioSolar() {
        ...
        int extraAnios = 50;
        int NumeroAnio = (anio - extraAnios) % 13; //Modulo 13
        int signoAnio = (anio - extraAnios) % 4; //Modulo 4
        while (NumeroAnio < 0) {
