...
public class CalendarioTonalpohualli {
    ...
    public String getSacredDate() {
        ...
        CalendarioTonalpohualli calendarioT = new CalendarioTonalpohualli(null);
        int diaJuliano = new Double(calendarioGregoriano.getDiaJuliano(calendario) - 0.5).intValue();
        int origen = 163;
        int diaAzteca = diaJuliano - origen;
        int tonalliDaySign = diaAzteca % 20;
        int tonalliDayNumber = diaAzteca % 13;

        int trecenasIndex = ((tonalliDaySign + 20) - tonalliDayNumber) % 20;

        return String.format("1-%s %s-%s",
                calendarioT.SEMANA[trecenasIndex], tonalliDayNumber + 1,
                calendarioT.SEMANA[tonalliDaySign]);
    }
    ...
    public String getDate() {
        return String.format("Solar date: " + getSolarDate() + ", Sacred date: " + getSacredDate());
    }
    */
}